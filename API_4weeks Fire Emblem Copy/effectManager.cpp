...
{
	EFFECTMANAGER->addEffect("빗나감", "빗나감", 1292, 32, 76, 32, 60, 0.01f, 30);
	EFFECTMANAGER->addEffect("명중함", "명중함", 308, 40, 44, 40, 40, 0.01f, 30);
	EFFECTMANAGER->addEffect("명중크리", "명중크리", 322, 36, 46, 36, 40, 0.01f, 30);
	return S_OK;
}
